...
const CreateInvoice = () => {
  ...
  const generatePdf = async (str?: string) => {
    ...
    containerDiv.style.backgroundSize = '840px 297px' // Adjust background size as needed
  ...
  const PrintPDFHTML = () => {
    return (
      <div>
        ...
        <Box width={'350px'} display={'flex'} flexDirection={'row'} justifyContent={'space-evenly'}>
          <FormGroup>
            <FormControlLabel
              control={
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {(invoiceType === InvoiceTypes.INTERIOR || invoiceType === InvoiceTypes.BOTH) && (
            <>
              ...
              <Box display={'flex'} flexDirection={'column'} justifyContent={'space-between'}>
                <TableContainer component={Paper} sx={{ borderRadius: 0, width: '750px', height: '100%' }}>
                  <Table>
                    <TableHead>
                      <TableRow>
                        <TableCell
                ...
                >
                  ...
                  {showInteriorWindow() && (
                    <TableContainer component={Paper} sx={{ borderRadius: 0, width: '750px', mt: 10 }}>
                      <Table>
                        <TableHead>
                          <TableCell
                            colSpan={1}
