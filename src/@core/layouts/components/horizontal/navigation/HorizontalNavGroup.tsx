...
//   const MainWrapper = WrapperCondition ? ClickAwayListener : Fragment
//   const ChildWrapper = WrapperCondition ? Fragment : 'div'
...
//   return (
//     <MainWrapper {...(WrapperCondition ? { onClickAway: handleGroupClose } : {})}>
